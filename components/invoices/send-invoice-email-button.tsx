...
import {
  markInvoiceSentOnMailtoAction,
  prepareInvoiceMailtoAction,
...
export function SendInvoiceEmailButton({
  ...
  async function loadDefaults() {
    ...
    const result = await prepareInvoiceMailtoAction(invoiceId);
  ...
  function handleOpenInMailApp() {
    ...
    startTransition(async () => {
      ...
      const sentResult = await markInvoiceSentOnMailtoAction(invoiceId);
      if (sentResult.error) {
      ...
      <Dialog open={open} onOpenChange={handleOpenChange}>
        ...
        >
          <DialogHeader className="shrink-0 space-y-1.5 border-b border-border/50 px-5 py-4 sm:px-6 sm:py-5">
            ...
            <DialogDescription>
              Le message inclut un lien sécurisé pour consulter, télécharger et
              régler la facture en ligne. Ouvrez votre messagerie pour
          ...
          <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain px-5 py-4 sm:px-6 sm:py-5">
            {loadingDefaults ? (
              ...
              <div className="space-y-4">
                <FormField label="Destinataire" htmlFor="invoice-email-to">
                  <Input
                    id="invoice-email-to"
                    type="email"
                ...
                <FormField label="Objet" htmlFor="invoice-email-subject">
                  <Input
                ...
                <FormField label="Message" htmlFor="invoice-email-message">
                  <Textarea
          ...
          <div className="shrink-0 border-t border-border/50 bg-popover px-5 py-4 sm:px-6 sm:py-5">
            <p className="text-xs leading-relaxed text-muted-foreground">
              Le lien public de paiement est déjà inclus dans le message. Vous
              pourrez le relire avant envoi depuis votre messagerie.
            </p>
